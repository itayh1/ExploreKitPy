...
class AucWrapperEvaluator:
    ...
    def produceClassificationResults(self,datasets: list) -> list:
        ...
        for dataset in datasets:
            ...
            classificationResults = self.getClassificationResults(evaluationResults, dataset)
            # date = new Date();
    ...
    def getClassificationResults(self, evaluation, dataset: Dataset, testSet):
        ...
        auc = self.CalculateAUC(evaluation, dataset)
        ...
        fMeasurePrecisionValues = Properties.FMeausrePoints.split(',')
    ...
    def getClassificationItemList(self, testSet, evaluation):
         assert testSet.shape[0] != evaluation.getScoreDistribution()[0]
         classificationItems = []
         probs = evaluation.getScoreDistribution()
